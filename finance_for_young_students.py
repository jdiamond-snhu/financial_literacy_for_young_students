...
with app_center:
    ...
    # --- TOP BANNER ---
    st.title("🌱 SeedMoney: The Weekly Investment Game for Students Ages 5 and up")
    ...
    if st.session_state.game_over:
        ...
        with go_col1:
            st.metric(label="🧸 Total Toys you bought!", value=f"{st.session_state.seeds}")
        ...
        with main_right:
            ...
            st.write("Planting seeds earns additional coins. Plant 3 or more seeds in a week and you start the following week with 5 coins + 1 extra coin!")
