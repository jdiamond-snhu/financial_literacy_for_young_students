...
# Set page layout to wide to comfortably fit the two-column grid
...
# Left Column = Action/Work Area (Flush Left)
# Right Column = Visual Plot & Savings Info Block
left_work_area, right_visual_area = st.columns([1, 1], gap="large")
